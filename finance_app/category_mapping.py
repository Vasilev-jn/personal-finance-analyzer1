...
BANK_CATEGORY_TO_BASE: Dict[Tuple[str, str], str] = {
    ...
    ("tinkoff", "экосистема сбер"): "base_shopping_groceries",
    ...
    ("tinkoff", "проценты"): "base_income_other",
    ("tinkoff", "транспорт"): "base_transport_public",
    ("tinkoff", "фото и копицентры"): "base_shopping_stationery",

    # Сбер
    ("sber", "супермаркеты"): "base_shopping_groceries",
    ("sber", "кафе рестораны фастфуд"): "base_food_restaurants",
    ("sber", "переводы людям"): "base_transfer_out",
    ("sber", "жкх связь интернет"): "base_home_services",
    ("sber", "автомобиль"): "base_transport_car_service",
    ("sber", "азс"): "base_transport_fuel",
    ("sber", "табачные магазины"): "base_shopping_alcohol",
    ("sber", "подписки"): "base_entertainment_digital",
    ("sber", "салоны красоты"): "base_beauty_services",
    ("sber", "комиссия"): "base_home_services",
    ("sber", "погашение кредитов"): "base_transfer_out",
    ("sber", "аптеки"): "base_shopping_pharmacy",
    ("sber", "госплатежи и налоги"): "base_taxes_state",
    ("sber", "маркетплейсы"): "base_shopping_marketplace",
    ("sber", "снятие наличных"): "base_cashout",
    ("sber", "бытовые услуги"): "base_home_services",
    ("sber", "такси и каршеринг"): "base_transport_taxi",
    ("sber", "путешествия"): "base_travel_other",
    ("sber", "одежда и обувь"): "base_shopping_clothes",
    ("sber", "перевозка доставка"): "base_transport_delivery",
    ("sber", "оптовая торговля"): "base_shopping_marketplace",
    ("sber", "членские организации"): "base_donations",
    ("sber", "хобби и развлечения"): "base_entertainment_other",
    ("sber", "медицинские услуги"): "base_health_medicine",
    ("sber", "ювелирные изделия"): "base_shopping_jewelry",
    ("sber", "образование"): "base_education_general",
    ("sber", "электроника и бытовая техника"): "base_shopping_electronics",
    ("sber", "бизнес услуги"): "base_home_services",
